...
// Mock data for the profile (no reviews or rating)
const profileData = {
  id: '1',
  name: 'Maria Rodriguez',
  location: 'New York, NY',
  coverImage: 'https://images.unsplash.com/photo-1632991727906-8386e1388975?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYXNoaW9uJTIwZGVzaWduZXIlMjBzdHVkaW98ZW58MXx8fHwxNzY2ODI3MTIwfDA&ixlib=rb-4.1.0&q=80&w=1080',
            ...
            <div className="relative mb-6">
              <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                ...
                <div className="flex gap-3 pb-2">
                  <button className="flex-1 sm:flex-none px-6 py-3 border-2 border-neutral-900 text-neutral-900 rounded-lg hover:bg-neutral-50 transition-colors flex items-center justify-center gap-2">
