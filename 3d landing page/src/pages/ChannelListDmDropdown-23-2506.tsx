import svgPaths from "./svg-96wpm6to0m";
...
import { imgAccessoriesAvatarProfilePic4 } from "./svg-j47dn";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="24 / mute">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_23_2560)" id="24 / mute">
          <g id="Vector"></g>
          <path d={svgPaths.pd70eb00} fill="var(--fill-0, #747881)" id="Union" />
        </g>
        <defs>
          <clipPath id="clip0_23_2560">
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="24 / attach">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g clipPath="url(#clip0_23_2557)" id="24 / attach">
