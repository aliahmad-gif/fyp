// Firebase helpers for WebSeller - Dashboard3D Studio
...
// Store heading
const heading = '3D Studio';
await addDoc(collection(db, 'sellerDashboardweb'), {
    page: 'Dashboard3DStudio',
    heading,
    timestamp: new Date()
}).catch(e => console.error('Failed to save Dashboard3DStudio heading:', e));
